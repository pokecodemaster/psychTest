...
fireBaseRef.child("Person2").child("WordTest 3").set("");
...
function writeToDB(currWord, selColor, randColor) {
    ...
    if (currWord != "") {
        ...
        fireBaseRef.child("Person2").child("WordTest 3").child(currWord.toUpperCase()).child("Displayed In").set(selColor);
        fireBaseRef.child("Person2").child("WordTest 3").child(currWord.toUpperCase()).child("Selected").set(randColor);
        fireBaseRef.child("Person2").child("WordTest 3").child(currWord.toUpperCase()).child("Status").set(status);
        fireBaseRef.child("Person2").child("WordTest 3").child(currWord.toUpperCase()).child("Time").set(time);
    }
